...
### Example text
 ...
 The text is found in [Introduction](./Introduction.md )
...
The relevant section of Cicero as printed in the source is reproduced below with fragments used in Lorem ipsum highlighted. Letters in brackets were added to Lorem ipsum and were not present in the source text: [here the text](./Workshop.md)

What follows is H. Rackham's translation, as printed in the 1914 Loeb edition, with words at least partially represented in Lorem ipsum highlighted: [here the translation](./Discussion%20Questions.md)
## Workshop
...
This is the Lorem Ipsum entry from [Wikipedia](https://en.wikipedia.org/wiki/Lorem_ipsum#External_links)
